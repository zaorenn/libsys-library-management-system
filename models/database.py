"""SQLite connection and schema lifecycle helpers for Lumina."""
...
DB_PATH: str | Path = Path(os.getenv("LUMINA_DB_PATH", BASE_DIR / "library.db"))
SCHEMA_PATH = BASE_DIR / "schema.sql"
DEFAULT_ADMIN_USERNAME = os.getenv("LUMINA_ADMIN_USERNAME", "admin")
DEFAULT_ADMIN_PASSWORD = os.getenv("LUMINA_ADMIN_PASSWORD", "Admin123!")
